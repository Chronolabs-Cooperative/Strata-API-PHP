...
if (!defined('API_MAINFILE_INCLUDED')) {
    ...
    define('API_ROOT_PATH', '/var/www/strata.snails.email');

    // For forward compatibility
    // Physical path to the API library directory WITHOUT trailing slash
    define('API_PATH', '/var/www/strata.snails.email/data');
    ...
    // Example: define('API_URL', 'http://strata.snails.email');
    define('API_URL', 'http://strata.snails.email');
    ...
    define('API_COOKIE_DOMAIN', 'strata.snails.email');
